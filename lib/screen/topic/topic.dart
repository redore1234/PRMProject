...
class AddTopictPage extends StatefulWidget {
  final String id;
  final String bearerToken;

  const AddTopictPage({Key key, @required this.id, @required this.bearerToken})
      : super(key: key);

  _AddTopicPageState createState() =>
      _AddTopicPageState(this.id, this.bearerToken);
}

class _AddTopicPageState extends State<AddTopictPage> {
  final String id;
  final String bearerTokent;
  MajorModel majorModel;

  _AddTopicPageState(this.id, this.bearerTokent);
